...
for radius in RADIUS:
    ...
    config = config+"K "+str(k)+"\n"
    config = config+"M "+str(m)+"\n"
    config = config+"RADIUS "+str(radius)+"\n"
    ...
    config = config+"init.graphinitializer initializers.GraphInitializer"+'\n'
    config = config+"init.graphinitializer.protocol lnk"+'\n'
    config = config+"init.graphinitializer.coordinateProtocol coordinateProtocol"+'\n'
    config = config+"init.graphinitializer.networksize NETWORK"+'\n'
    config = config+"init.graphinitializer.bound BOUND"+'\n'
    config = config+"init.graphinitializer.fileprefix "+topology+"graph"+'\n'
    config = config+"init.graphinitializer.foldername configstore"+'\n'
    config = config+""+'\n'
    ...
    config = config+"control.initechostate echorange.InitEcho"+'\n'
    ...
    config = config+"protocol.echostate echorange.EchoState"+'\n'
    config = config+""+'\n'

    config = config+"protocol.invoke echorange.Invoke"+'\n'
    ...
    config = config+"protocol.echo echorange.Echo"+'\n'
    ...
    config = config+"include.init initializeCoordinates graphinitializer topologyobserver initializegaptable gaptableobserver initechoscheduler"+'\n'
    config = config+""+'\n'
